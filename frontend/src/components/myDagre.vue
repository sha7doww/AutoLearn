<template>
  <div>
    ...
    <button @click="highlightNodes">确定</button> <!-- 添加确定按钮 -->
    ...
    createNetwork() {
      const nodes = new DataSet([
       { id: 1, label: '数学分析', url: 'https://example.com/page1' },
        ...
        { id: 67, label: '大学英语', url: 'https://example.com/page67' }
      ]);

      const edges = new DataSet([
         { from:34, to:16, arrows: 'to' },
        { from:30, to:16, arrows: 'to' },
        { from:1, to:16, arrows: 'to' },
        { from:1, to:31, arrows: 'to' },
        { from:1, to:32, arrows: 'to' },
        { from:1, to:17, arrows: 'to' },
        { from:39, to:17, arrows: 'to' },
        { from:50, to:17, arrows: 'to' },
        { from:37, to:17, arrows: 'to' },
        { from:11, to:18, arrows: 'to' },
        { from:30, to:21, arrows: 'to' },
        { from:37, to:21, arrows: 'to' },
        { from:66, to:22, arrows: 'to' },
        { from:30, to:23, arrows: 'to' },
        { from:1, to:24, arrows: 'to' },
        { from:39, to:24, arrows: 'to' },
        { from:33, to:24, arrows: 'to' },
        { from:29, to:24, arrows: 'to' },
        { from:37, to:25, arrows: 'to' },
        { from:30, to:25, arrows: 'to' },
        { from:39, to:26, arrows: 'to' },
        { from:34, to:28, arrows: 'to' },
        { from:11, to:28, arrows: 'to' },
        { from:44, to:28, arrows: 'to' },
        { from:40, to:28, arrows: 'to' },
        { from:29, to:36, arrows: 'to' },
        { from:30, to:37, arrows: 'to' },
        { from:33, to:36, arrows: 'to' },
        { from:34, to:36, arrows: 'to' },
        { from:35, to:36, arrows: 'to' },
        { from:37, to:36, arrows: 'to' },
        { from:1, to:36, arrows: 'to' },
        { from:39, to:35, arrows: 'to' },
        { from:39, to:36, arrows: 'to' },
        { from:40, to:2, arrows: 'to' },
        { from:53, to:2, arrows: 'to' },
        { from:1, to:3, arrows: 'to' },
        { from:35, to:3, arrows: 'to' },
        { from:30, to:3, arrows: 'to' },
        { from:33, to:4, arrows: 'to' },
        { from:36, to:4, arrows: 'to' },
        { from:40, to:5, arrows: 'to' },
        { from:50, to:6, arrows: 'to' },
        { from:66, to:6, arrows: 'to' },
        { from:22, to:7, arrows: 'to' },
        { from:37, to:8, arrows: 'to' },
        { from:49, to:8, arrows: 'to' },
        { from:50, to:8, arrows: 'to' },
        { from:49, to:9, arrows: 'to' },
        { from:50, to:9, arrows: 'to' },
        { from:1, to:9, arrows: 'to' },
        { from:39, to:9, arrows: 'to' },
        { from:33, to:9, arrows: 'to' },
        { from:30, to:9, arrows: 'to' },
        { from:1, to:10, arrows: 'to' },
        { from:33, to:10, arrows: 'to' },
        { from:39, to:10, arrows: 'to' },
        { from:36, to:10, arrows: 'to' },
        { from:41, to:11, arrows: 'to' },
        { from:40, to:11, arrows: 'to' },
        { from:40, to:12, arrows: 'to' },
        { from:41, to:12, arrows: 'to' },
        { from:41, to:13, arrows: 'to' },
        { from:1, to:14, arrows: 'to' },
        { from:33, to:14, arrows: 'to' },
        { from:36, to:14, arrows: 'to' },
        { from:39, to:14, arrows: 'to' },
        { from:30, to:40, arrows: 'to' },
        { from:37, to:40, arrows: 'to' },
        { from:53, to:40, arrows: 'to' },
        { from:40, to:41, arrows: 'to' },
        { from:43, to:41, arrows: 'to' },
        { from:30, to:42, arrows: 'to' },
        { from:53, to:42, arrows: 'to' },
        { from:38, to:42, arrows: 'to' },
        { from:37, to:42, arrows: 'to' },
        { from:40, to:43, arrows: 'to' },
        { from:53, to:43, arrows: 'to' },
        { from:30, to:43, arrows: 'to' },
        { from:37, to:44, arrows: 'to' },
        { from:40, to:44, arrows: 'to' },
        { from:30, to:45, arrows: 'to' },
        { from:35, to:45, arrows: 'to' },
        { from:37, to:45, arrows: 'to' },
        { from:40, to:45, arrows: 'to' },
        { from:41, to:46, arrows: 'to' },
        { from:34, to:46, arrows: 'to' },
        { from:36, to:46, arrows: 'to' },
        { from:39, to:47, arrows: 'to' },
        { from:30, to:49, arrows: 'to' },
        { from:30, to:50, arrows: 'to' },
        { from:34, to:51, arrows: 'to' },
        { from:67, to:51, arrows: 'to' },
        { from:1, to:52, arrows: 'to' },
        { from:36, to:54, arrows: 'to' },
        { from:40, to:55, arrows: 'to' },
        { from:39, to:55, arrows: 'to' },
        { from:35, to:55, arrows: 'to' },
        { from:37, to:55, arrows: 'to' },
        { from:44, to:55, arrows: 'to' },
        { from:29, to:55, arrows: 'to' },
        { from:36, to:56, arrows: 'to' },
        { from:37, to:56, arrows: 'to' },
        { from:36, to:57, arrows: 'to' },
        { from:37, to:57, arrows: 'to' },
        { from:39, to:57, arrows: 'to' },
        { from:7, to:57, arrows: 'to' },
        { from:1, to:58, arrows: 'to' },
        { from:33, to:58, arrows: 'to' },
        { from:1, to:59, arrows: 'to' },
        { from:36, to:60, arrows: 'to' },
        { from:49, to:61, arrows: 'to' },
        { from:22, to:62, arrows: 'to' },
        { from:14, to:62, arrows: 'to' },
        { from:36, to:63, arrows: 'to' },
        { from:42, to:64, arrows: 'to' },
        { from:4, to:64, arrows: 'to' },
        { from:14, to:64, arrows: 'to' },
      ...
      this.nodes.forEach((node) => {
        if (node.label.toLowerCase().includes(query)) {
          ...
          this.network.focus(node.id, {
            scale: 1.5, // 控制放大比例，可以调整这个值
            animation: {
              duration: 500, // 动画持续时间（毫秒）
              easingFunction: 'easeInOutQuad', // 动画效果
            },
          });
        }
      });
